...
def conflitos(codigos, creditos): #Esse parametro são as disciplinas que vão ser analizadas até o momento   
...
def recomendacao(subjects_released, disciplinas):
    ...
    for disciplina, info in disciplinas_ordenadas[1:]:
        ...
        if carga_atual + info["creditos"] <= carga_max:
            ...
            if conflitos(disciplina, info["creditos"]):
